...
public class SignUpGUI extends GUI {
    ...
    public SignUpGUI(DBMananger dbM)
    {
        super(dbM);
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (jTextField1.getText().length() == 0 ||
            ...
            JOptionPane.showMessageDialog(null, "Uzupełnij puste pola!");
            return;
        }
        
        Vector newValuesAccount = new Vector();
        Vector newValuesUser = new Vector();

        String accountId = incrementId("id_konta","konto_uzytkownika");
        ...
        String hash = hash(jTextField3.getText());
        newValuesAccount.add(hash);
        
        dbManager.insertRow("konto_uzytkownika",newValuesAccount);
        
        newValuesUser.add(incrementId("user_id","uzytkownik"));
        newValuesUser.add(jTextField2.getText());
        newValuesUser.add(jTextField4.getText());
        newValuesUser.add(jTextField6.getText());
        newValuesUser.add(jTextField5.getText());
        newValuesUser.add(accountId);

        dbManager.insertRow("uzytkownik",newValuesUser);

        JOptionPane.showMessageDialog(null, "Założenie konta powiodło się!");
        GUI.changeWindow(this,new MainGUI(dbManager));
